...
\urlstyle{same}
\hypersetup{
  pdftitle={Page with no linked terms},
  pdflang={en-GB},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Page with no linked terms}
\author{}
\date{}
\begin{document}
\maketitle
...
This mention of groups should not link to the
\href{template-group.qmd}{group page}.

This mention of Følner sequences should not link to the
\href{template-folner.qmd}{Følner sequences page}.
