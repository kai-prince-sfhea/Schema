...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, leftrule=.75mm, breakable, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, toptitle=1mm, rightrule=.15mm, titlerule=0mm, left=2mm]
