...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, bottomrule=.15mm, opacityback=0, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, colback=white, titlerule=0mm, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6]
