...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, coltitle=black, breakable, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, colback=white, toptitle=1mm, left=2mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, rightrule=.15mm, opacityback=0]
