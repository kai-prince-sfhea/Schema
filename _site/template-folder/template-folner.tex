...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, toprule=.15mm, titlerule=0mm, toptitle=1mm, breakable, bottomtitle=1mm, left=2mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}]
