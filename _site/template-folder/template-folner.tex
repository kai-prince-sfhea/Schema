...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, toprule=.15mm, left=2mm, titlerule=0mm, opacityback=0, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, rightrule=.15mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, coltitle=black, breakable]
