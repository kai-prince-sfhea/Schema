...
* {{< term ref="def-associativity" templateMap="[\\Group,\\GroupOperation,\\Identity,g,h,j]" title=true >}}
* {{< term ref="def-identity" templateMap="[\\Group,\\GroupOperation,\\Identity,g,h,j]" title=true >}}
* {{< term ref="def-inverse" templateMap="[\\Group,\\GroupOperation,\\Identity,g,h,j]" title=true >}}
:::
